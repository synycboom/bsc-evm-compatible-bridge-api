...
func (o *GetErc1155SwapsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetErc1155SwapsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetErc1155SwapsURL")
	}
