...
// NewGetErc1155SwapsParams creates a new GetErc1155SwapsParams object
...
// GetErc1155SwapsParams contains all the bound params for the get erc1155 swaps operation
...
func (o *GetErc1155SwapsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetErc1155SwapsParams()
		return nil
	}
...
func (o *GetErc1155SwapsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetErc1155SwapsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetErc1155SwapsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetErc1155SwapsParams) bindRequestTxHash(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetErc1155SwapsParams) validateRequestTxHash(formats strfmt.Registry) error {
...
func (o *GetErc1155SwapsParams) bindSender(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetErc1155SwapsParams) validateSender(formats strfmt.Registry) error {
...
func (o *GetErc1155SwapsParams) bindState(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetErc1155SwapsParams) validateState(formats strfmt.Registry) error {
