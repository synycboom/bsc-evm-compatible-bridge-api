...
func (o *GetErc721SwapPairsURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/erc-721-swap-pairs"
...
func (o *GetErc721SwapPairsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetErc721SwapPairsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetErc721SwapPairsURL")
	}
